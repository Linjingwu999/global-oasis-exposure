...
|---|---|---|
| 2020 global oasis boundary lineage | Fixed population of 3,443 polygons; identifiers and derived summaries only; geometries excluded | [Dataset catalogue DOI](https://doi.org/10.3974/geodp.2025.03.01) |
...
The file `data/source_product_manifest.csv` records the version or period, analysis role, and redistribution status for each product. Nothing in the MIT or CC BY 4.0 licences grants rights in third-party source products.
